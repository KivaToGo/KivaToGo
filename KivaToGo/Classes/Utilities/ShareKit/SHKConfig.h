...
#define SHKMyAppName			@"KivaToGo"
#define SHKMyAppURL				@"http://www.KivaToGo.com"
...
#define SHKDeliciousConsumerKey		@"dj0yJmk9d1FIc2dvTTNnMnBrJmQ9WVdrOU0yVldkM0ZYTm5NbWNHbzlNVFkzT0Rjd05EVTJNZy0tJnM9Y29uc3VtZXJzZWNyZXQmeD0zNQ--"
#define SHKDeliciousSecretKey		@"221bdd583967f8cb6529cbbb184fb5b2d9f18a66"
...
#define SHKReadItLaterKey			@"e2edNjMnT6787qORDmAqK24nF3g2f4c7"
 ...
 */
#define SHKTwitterConsumerKey		@"kQWeCqhvtex9bw1PJCIEbA"
#define SHKTwitterSecret			@"0gzIuawPQRAU4PPJ0KdDCaUMX3OPMtIdr8MXrepwg"
#define SHKTwitterCallbackUrl		@"http://www.kivatogo.com/awesome" // You need to set this if using OAuth, see note above (xAuth users can skip it)
#define SHKTwitterUseXAuth			0 // To use xAuth, set to 1
#define SHKTwitterUsername			@"KivaToGo" // Enter your app's twitter account if you'd like to ask the user to follow it when logging in. (Only for xAuth)

// Bit.ly (for shortening URLs on Twitter) - http://bit.ly/account/register - after signup: http://bit.ly/a/your_api_key
#define SHKBitLyLogin				@"kivatogo"
#define SHKBitLyKey					@"R_c94b9a4b23409ec776350716f4ad8ec2"
